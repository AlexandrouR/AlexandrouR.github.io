...
![image](https://docs.web3j.io/_images/web3j_transaction.png)
...
`management_apis`{.interpreted-text role="doc"}.
...
`smart-contract-wrappers`{.interpreted-text role="ref"} which take care of all code generation and this conversion for you.
...
web3j takes care of the function encoding for you, for further details on the implementation refer to the `abi`{.interpreted-text role="doc"} section.
...
refer to the `filters`{.interpreted-text role="doc"} section for details.
